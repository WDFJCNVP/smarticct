...
<html lang="en">
  ...
  <body class="min-h-screen bg-white dark:bg-zinc-800 antialiased">
      <flux:sidebar sticky collapsible="mobile" class="bg-zinc-50 dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-700">
          ...
          <x-dashboard.sidebar-menu.sidebar-item href="/operator/dashboard" icon="home"> Dashboard </x-dashboard.sidebar-menu.sidebar-item>
         ...
         <x-dashboard.sidebar-menu.sidebar-item href="/operator/notifaction" icon="home">Your Card</x-dashboard.sidebar-menu.sidebar-item>
          ...
          <flux:dropdown position="top" align="start" class="max-lg:hidden">
              <flux:sidebar.profile avatar="https://fluxui.dev/img/demo/user.png" name="{{ auth()->user()->first_name }}" />
              <flux:menu>
