...
{
    // 'sidebar' = desktop sidebar profile trigger, 'mobile' = mobile header profile trigger
    ...
    <flux:dropdown position="top" align="end">
        <div class="relative inline-block">
            ...
            @if ($this->unreadCount > 0)
                <span class="absolute top-0 right-4 -translate-y-1/2 flex h-2.5 w-2.5 pointer-events-none z-10">
