...
<div>
    ...
    <x-page-header
        heading="Cards"
        description="View all registered cards and manage lost card reports."
        class="mb-6"
    >
        ...
        <div class="overflow-x-auto">
            <flux:table container:class="md:max-h-160">
                <flux:table.columns sticky class="bg-light-secondary/50 items-center bg-light-subtle/50 dark:bg-dark-secondary/50 font-secondary text-nav-label text-light-txt-muted dark:text-dark-txt-muted">
                    ...
                    <flux:table.column align="center" class="hidden md:table-cell px-1 sm:px-2 md:px-4 py-2">Owner ID</flux:table.column>
                    <flux:table.column align="center" class="hidden sm:table-cell px-1 sm:px-2 md:px-4 py-2">Card no.</flux:table.column>
                    ...
                    <flux:table.column align="center" class="hidden md:table-cell px-1 sm:px-2 md:px-4 py-2">Registered</flux:table.column>
                ...
                <flux:table.rows>
                    @forelse ($this->getUsers as $index => $user)
                        <flux:table.row :key="$user->id">
                            ...
                            <flux:table.cell align="center" class="hidden sm:table-cell px-1 sm:px-2 md:px-4 py-1.5 md:py-2">
            ...
            <div class="flex flex-col p-4 sm:p-6 !pr-4 sm:!pr-6 space-y-5 overflow-y-auto max-h-[70vh]">
                ...
                <div class="flex items-center gap-3 p-3 rounded-lg bg-light-subtle dark:bg-dark-subtle">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="font-secondary text-xs text-light-txt-muted dark:text-dark-txt-muted truncate">{{ $report->user->user_code }}</p>
                    </div>
    ...
    <flux:modal wire:model="show_reject_report_modal" :closable="false" class="w-[calc(100%-2rem)] max-w-xs sm:max-w-sm">
        <div class="space-y-6">
            <div>
                ...
                <flux:text class="mt-2">The commuter will need to re-submit their card report.</flux:text>
            </div>
            <div class="flex gap-2">
                <flux:spacer />
                <flux:modal.close>
